...
| [Optimizer ownership comparison Spec Kit prompt](tinystories_optimizer_ownership_speckit_prompt.md) | Draft feature input; not executed | Yes for the new nine-run series | Actionable prompt covering the agreed matrix, corrected budgets, optimizer/clipping semantics, artifacts, comparisons, acceptance tests, and explicitly proposed defaults to clarify. |
